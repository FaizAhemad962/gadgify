...
export const CartProvider = ({ children }: { children: ReactNode }) => {
  ...
  const addBufferRef = useRef<Record<string, { quantity: number; timer: ReturnType<typeof setTimeout> | null; promise?: Promise<void> }>>({})
  ...
  const scheduleBufferedAdd = (productId: string, quantity: number): Promise<void> => {
