...
router.post("/forgot-password", rateLimiter_1.authLimiter, (0, validate_1.validate)(validators_1.forgotPasswordSchema), authController_1.forgotPassword);
router.post("/reset-password", rateLimiter_1.authLimiter, (0, validate_1.validate)(validators_1.resetPasswordSchema), authController_1.resetPassword);
